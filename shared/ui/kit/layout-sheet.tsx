  ...
  return (
    <SheetPrimitive.Portal data-slot="layout-sheet-portal">
      <SheetPrimitive.Content
        ...
        className={cn(
          "bg-background text-primary data-[state=closed]:animate-out data-[state=open]:animate-in fixed z-50 flex flex-col gap-4 shadow-lg transition-[top,transform,opacity] ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-300",
          side === "right" &&
