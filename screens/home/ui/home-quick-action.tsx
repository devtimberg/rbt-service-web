          ...
          {HOME_QUICK_ACTIONS.map((action) => {
            ...
            return (
              <Link
                ...
                href={action.href}
                className={cn(
                  "text-inverse bg-primary-300 flex w-full flex-col items-center justify-center gap-3 rounded-3xl px-3 py-4 text-center transition-colors md:min-h-[116px] md:flex-row md:justify-start md:rounded-2xl md:px-4 md:py-3 md:text-left",
                  isAccent ? "bg-secondary-500" : "null",
                )}
              >
                <span className="inline-flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl border border-white/25 bg-white/10 md:h-16 md:w-16 md:rounded-xl">
                  <Icon
